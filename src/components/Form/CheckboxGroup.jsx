...
const CheckboxGroup = ({
    ...
    const handleChange = (optionValue) => {
        ...
        if (value !== null) {
            // Object format: {applyRenew: true, discuss: false, getNotice: true}
            newValue = {
                ...value,
    ...
    return (
        <div className="w-full">
            ...
            <div className="space-y-2 relative" onMouseEnter={() => setIsHovered(true)} onMouseLeave={() => setIsHovered(false)}>
                {options.map((option) => (
